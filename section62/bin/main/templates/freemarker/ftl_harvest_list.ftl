...
<body>
  <div class="container">
      <div class="col-lg-6">
            ...
            <div class="panel-heading"><h3 style="color : #006400">Product List</h3></div>
				            ...
				            <td colspan="12" class="hiddenRow"><div class="accordian-body collapse" id="${h.id}"> 
				              <table class="table table-striped">
				                 <thead>
				                   ...
				                   <tbody>
				                     <tr><td>${h.description}</td><td>${h.type}</td><td>${h.status}</td><td><a href="#" class="btn btn-default btn-sm">
